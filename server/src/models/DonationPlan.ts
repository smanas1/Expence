...
export const DonationPlanModel =
  mongoose.models.DonationPlan ?? mongoose.model("DonationPlan", donationPlanSchema);

type LegacyDonationPlan = {
...
export function normalizeDonationPlan(plan: LegacyDonationPlan) {
